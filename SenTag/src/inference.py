...
class InferModel:
    def __init__(self, device, bert_model, label_list, model_dir, max_seq_length, max_sent_length, rule_features_path,
                 batch_size):
        self.device = device
        ...
        self.sentag_model = SenTag.from_pretrained(bert_model, config=self.config,
                                                   label_list=label_list, num_rule_features=self.num_rule_features,
                                                   device=self.device)
